            ...
            <div className="card">
                    <div className="p-6">
                        ...
                        <div className="mt-6">
                            ...
                            <h3>Key Insights:</h3>
                            <ul>
                                <li><strong>Teenagers (14-16) Have the Highest Contact:</strong> With <strong>207 interactions</strong>, this group experiences the most engagement with police, significantly surpassing all other age groups.</li>
