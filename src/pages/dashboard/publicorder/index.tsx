...
const BehavioralIncidents = () => {
	return (
		...
		<div className="xl:col-span-3">
			<div className="card">
				<div className="p-6">
					<h4 className="card-title">School-based infractions</h4>
					<div dir="ltr">
		...
		<div className="xl:col-span-6">
			...
			<div className="gap-6 mb-6 flex">
				<div className="col-span-3">
					<StatisticsWidget variant={'bg-success'} cardTitle={'Average response times'} title={'Number of customers'} change={'2,541'} stats={'54,214'} dataSince={'Since last month'} classname={'apex-charts'} chartSeries={[58, 42]} colors={['#47ad77', '#e3e9ee']} />
				</div>

				<div className="col-span-3">
					<StatisticsWidget variant={'bg-danger'} cardTitle={'Parent notification rates'} title={'Number of Orders'} change={'1.08%'} stats={'7,543'} dataSince={'Since last month'} classname={'apex-charts'} chartSeries={[34, 66]} colors={['#3e60d5', '#e3e9ee']} />
				</div>  
			</div>
			...
			<div className="grid xl:grid-cols-3 gap-6">
				<div className="col-span-3 gap-6 mb-6">
					<div className="card">
						<div className="p-6">
							<h4 className="card-title mb-4">Resolution methods used</h4>
							<div dir="ltr">
