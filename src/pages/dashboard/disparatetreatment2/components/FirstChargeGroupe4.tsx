...
const intReferral: ApexOptions = {
	...
	xaxis: {
		categories: ['Larceny', 'Larceny From Buildings', 'Larceny From Motor Vehicle', 'Motor Vehicle Theft Of ALl','Motor Vehicle Theft Of','Murder & Non-Negligent'],
	},
	legend: {
		position: 'top',
		offsetY: 5,
	...
	return (
        <div className="xl:col-span-6">
            <div className="card">
                <div className="p-6">
                    <h4 className="card-title mb-4">1st Charge Groupe 4</h4>
                    <div dir="ltr">
                    <ReactApexChart
